...
const Navbar = () => {
  return (
    <nav className="max-w-[90rem] mx-auto flex justify-between text-[14px] items-center px-4 py-3 border-gray-200 bg-white">
      <div className="flex items-center space-x-8 font-semibold text-gray-600">
        ...
        <a href="#" className=" hover:text-purple-600 flex justify-center items-center">Tracking Page <span className='ml-2 mt-[2px]'><img src={Arrow}/></span></a>
